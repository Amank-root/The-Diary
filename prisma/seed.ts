...
async function main() {
    ...
    const convertDates = (obj: any) => {
        ...
        if (converted.updatedAt) converted.updatedAt = new Date(converted.updatedAt);
        if (converted.accessTokenExpiresAt) converted.accessTokenExpiresAt = new Date(converted.accessTokenExpiresAt);
        if (converted.refreshTokenExpiresAt) converted.refreshTokenExpiresAt = new Date(converted.refreshTokenExpiresAt);
        return converted;
    };
