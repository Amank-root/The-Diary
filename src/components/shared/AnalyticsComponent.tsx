  ...
  const recentEntries = [
    {
      ...
      preview:
        'Today was absolutely wonderful. The weather was perfect and I spent time...',
      date: 'August 18, 2025',
      mood: 'Happy',
    ...
    },
    {
      ...
      preview:
        "I've been thinking a lot about personal growth lately. It's interesting how...",
      date: 'August 17, 2025',
      mood: 'Thoughtful',
    ...
    },
    {
      ...
      preview:
        'This weekend was packed with activities. From hiking in the morning to...',
      date: 'August 16, 2025',
      mood: 'Excited',
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {recentEntries.map((entry) => (
            <div
              key={entry.id}
              className="border rounded-lg p-3 lg:p-4 hover:bg-accent/50 transition-colors cursor-pointer"
            >
