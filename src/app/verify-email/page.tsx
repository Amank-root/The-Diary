      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex justify-center mb-8">
          <div className="relative">
            ...
            <div className="relative rounded-full p-6 shadow-lg border border-slate-200">
        ...
        {/* Content */}
        <div className=" rounded-2xl shadow-lg border p-8 sm:p-10 text-center">
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">
            <span className="text-balance">Check your email</span>
          </h1>

          <p className="light:text-slate-600 dark:text-slate-400 text-lg mb-2 leading-relaxed">
          ...
          <div className=" border rounded-xl p-4 mb-8 text-left">
            <p className="text-sm light:text-slate-700 dark:text-slate-300 flex items-start gap-3">
          ...
          <Button
            variant="ghost"
            className="w-full h-11 text-base font-semibold light:text-slate-700 hover:bg-blue-300"
            asChild
          >
          ...
          {/* Footer Info */}
          <div className="mt-8 pt-6 border-t light:border-slate-200">
            <p className="text-xs text-slate-500">
              Link expires in{' '}
              <span className="font-semibold light:text-slate-700 dark:text-slate-300">
                1 hours
              </span>
            </p>
          </div>
        ...
        {/* Security Notice */}
        <div className="mt-8 text-center text-xs light:text-slate-500">
