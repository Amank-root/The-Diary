...
//                 const color = diaryTypeColors[diary.types as keyof typeof diaryTypeColors] || diaryTypeColors.DEFAULT;
//                 return (
//                   <div 
//                     key={diary.id}
...
//             </div>
//             <div className="mt-3 pt-2 border-t text-center text-sm text-gray-600">
//               Total: {data._count.diaries} diaries • {data.diaries.reduce((sum, d) => sum + d.pages.length, 0)} pages
//             </div>
//           </div>
//         ),
//       },
...
//         label: (
//           <div className="p-4">
//             <h3 className="font-bold text-lg mb-3 text-center text-green-700">👥 Followers</h3>
//             <div className="space-y-2">
//               {data.readers.length > 0 ? (
//                 data.readers.map((reader, index) => (
//                   <div 
...
//                     </div>
//                     <div className="flex-1">
//                       <div className="font-semibold text-sm">Follower {index + 1}</div>
//                       <div className="text-xs text-gray-500">
//                         Since {new Date(reader.createdAt).toLocaleDateString()}
//                       </div>
//                     </div>
...
//                 ))
//               ) : (
//                 <div className="text-center text-gray-500 py-4">No followers yet</div>
//               )}
//             </div>
//             <div className="mt-3 pt-2 border-t text-center text-sm text-green-600 font-semibold">
//               {data.readers.length} followers
//             </div>
//           </div>
//         ),
...
//         label: (
//           <div className="p-4">
//             <h3 className="font-bold text-lg mb-3 text-center text-orange-700">👁️ Following</h3>
//             <div className="space-y-2">
//               {data.reading.length > 0 ? (
//                 data.reading.map((reading, index) => (
//                   <div 
...
//                     </div>
//                     <div className="flex-1">
//                       <div className="font-semibold text-sm">Following {index + 1}</div>
//                       <div className="text-xs text-gray-500">
//                         Since {new Date(reading.createdAt).toLocaleDateString()}
//                       </div>
//                     </div>
...
//                 ))
//               ) : (
//                 <div className="text-center text-gray-500 py-4">Not following anyone</div>
//               )}
//             </div>
//             <div className="mt-3 pt-2 border-t text-center text-sm text-orange-600 font-semibold">
//               {data.reading.length} following
//             </div>
//           </div>
//         ),
...
//     // Create edges connecting containers to central user
//     edges.push(
//       // Diaries to User
//       {
//         id: 'diaries-to-user',
...
//   return (
//     <div className="w-full relative h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:text-black">
//       {/* Legend */}
//       <div className="absolute top-8 left-4 z-10 bg-white p-4 rounded-lg shadow-lg border">
//         <h3 className="font-semibold mb-3">Diary Types</h3>
//         <div className="space-y-2 text-sm">
//           <div className="flex items-center gap-2">
//             <div className="w-4 h-4 bg-red-500 rounded-full"></div>
...
//       {/* Quick Stats */}
//       <div className="absolute top-8 right-4 z-10 bg-white p-4 rounded-lg shadow-lg border">
//         <h3 className="font-semibold mb-3">Quick Stats</h3>
//         <div className="space-y-2 text-sm">
//           <div className="flex justify-between gap-4">
//             <span>📚 Diaries:</span>
...
//           <div className="flex justify-between gap-4">
//             <span>📄 Pages:</span>
//             <span className="font-bold">{data.diaries.reduce((sum, d) => sum + d.pages.length, 0)}</span>
//           </div>
//           <div className="flex justify-between gap-4">
//             <span>👥 Followers:</span>
//             <span className="font-bold text-green-600">{data.readers.length}</span>
//           </div>
//           <div className="flex justify-between gap-4">
//             <span>👁️ Following:</span>
//             <span className="font-bold text-orange-600">{data.reading.length}</span>
//           </div>
//         </div>
//       </div>
...
//       >
//         {/* @ts-ignore */}
//         <Background color="#e0e7ff" variant="dots" gap={20} size={1} />
//         <Controls />
//       </ReactFlow>
//     </div>
//   );
